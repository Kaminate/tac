...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    ImU32 hue_colofloat = ColorConvertFloat4ToU32(hue_color_f);
    ...
    if (flags & ImGuiColorEditFlags_PickerHueWheel)
    {
        ...
        draw_list->AddCircleFilled(hue_cursor_pos, hue_cursor_rad, hue_colofloat, hue_cursor_segments);
        ...
        draw_list->PrimVtx(tra, uv_white, hue_colofloat);
        draw_list->PrimVtx(trb, uv_white, hue_colofloat);
    ...
    {
        // Render SV Square
        draw_list->AddRectFilledMultiColor(picker_pos, picker_pos + ImVec2(sv_picker_size,sv_picker_size), IM_COL32_WHITE, hue_colofloat, hue_colofloat, IM_COL32_WHITE);
