...
namespace Tac::Render
{
  ...
  {
    auto CreateTexture( CreateTextureParams, Errors& ) -> TextureHandle;
    void CreateRenderTargetColor( TextureHandle, PCom< ID3D12Resource >, SwapChainParams, int, Errors& );
    void UpdateTexture( TextureHandle, UpdateTextureParams, DX12Context*, Errors& );
    void DestroyTexture( TextureHandle );
    auto FindTexture( TextureHandle ) -> DX12Texture*;
    void TransitionTexture( TextureHandle, DX12TransitionHelper* );
    void SetName( TextureHandle, StringView );
    void TransitionResource( DX12Resource*, Binding, DX12TransitionHelper* );
  ...
  private:
    ...
    {
      Bindings() = default;
      Bindings( ID3D12Resource*, const CreateTextureParams& );
    ...
    void UploadTextureData( DX12Resource*, UpdateTextureParams, DX12Context*, Errors& );
