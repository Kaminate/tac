...
namespace Tac::Render
{
  ...
  static String PreprocessShaderRegister( const StringView line )
  {
    ...
    String result;
    result += va( "// Autogenerated register from %s\n", __FUNCTION__ );
    result += line.substr( 0, iReplace );
    result += va( "register( %c%d )", resourceLetter, iResource );
  ...
  static String PreprocessShaderIncludes( const StringView line, Errors& errors )
  {
    ...
    const String includeSource = Filesystem::LoadAssetPath( includeAssetPath, errors );
