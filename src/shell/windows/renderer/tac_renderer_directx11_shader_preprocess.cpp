#include "src/shell/windows/renderer/tac_renderer_directx11_shader_preprocess.h" // self-inc
...
namespace Tac::Render
{
  ...
  static String PreprocessShaderRegister( const StringView line )
  {
    ...
    String result;
    result += va( "// Autogenerated register from {}\n", __FUNCTION__ );
  ...
  static String PreprocessShaderIncludes( const StringView line, Errors& errors )
  {
    ...
    //const String     includeSource = Filesystem::FileToString( ::ShaderPathToContentString( includePath, errors );
  ...
  static String PreprocessShaderBitfield( const StringView line )
  {
    ...
    if( line.contains( "TAC_DEFINE_BITFIELD_ELEMENT" ) )
    {
      ...
      result += "  ";
      result += "return ( flags >> ";
      result += ToString( oldRunningBitCount );
      result += ") & ( ( 1 << ";
      result += ToString( bitCount );
      result += " - 1 );\n";
