...
#define TAC_MAKE_EXAMPLE_FACTORY( T ) []()->Example*{ return TAC_NEW T; }
  void ExampleRegistryPopulate()
  {
    ...
    ExampleRegistryAdd( "Physics - Sim 2 Integration", TAC_MAKE_EXAMPLE_FACTORY( ExamplePhysSim2Integration ) );
    ExampleRegistryAdd( "Physics - Sim 3 Torque", TAC_MAKE_EXAMPLE_FACTORY( ExamplePhysSim3Torque ) );
    ExampleRegistryAdd( "Physics - Sim 4 Tank", TAC_MAKE_EXAMPLE_FACTORY( ExamplePhysSim4Tank ) );
    ExampleRegistryAdd( "Physics - Sim 5 Lin Collision", TAC_MAKE_EXAMPLE_FACTORY( ExamplePhysSim5LinCollision ) );
    ExampleRegistryAdd( "Physics - Sim 6 Rot Collision", TAC_MAKE_EXAMPLE_FACTORY( ExamplePhysSim6RotCollision ) );
    ExampleRegistryAdd( "Physics - Sim 7 Friction", TAC_MAKE_EXAMPLE_FACTORY( ExamplePhysSim7Friction ) );
  }
