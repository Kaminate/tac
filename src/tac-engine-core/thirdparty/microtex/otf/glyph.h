...
public:
  KernRecord(const KernRecord&) = delete;
  void operator=( const KernRecord& ) = delete;
...
public:
  ...
  void operator=( const Variants& ) = delete;
...
public:
  GlyphPart(const GlyphPart&) = delete;
  void operator=( const GlyphPart& ) = delete;
...
public:
  GlyphAssembly(const GlyphAssembly&) = delete;
  void operator=( const GlyphAssembly& ) = delete;
...
public:
  MathKern(const MathKern&) = delete;
  void operator=( const MathKern& ) = delete;
...
public:
  MathKernRecord(const MathKernRecord&) = delete;
  void operator=( const MathKernRecord& ) = delete;
...
public:
  ...
  void operator=( const Glyph& ) = delete;
