...
namespace Tac
{
  ...
  TAC_META_REGISTER_STRUCT_BEGIN( Terrain );
  TAC_META_REGISTER_STRUCT_MEMBER( mSideVertexCount );
  TAC_META_REGISTER_STRUCT_MEMBER( mSideLength );
  TAC_META_REGISTER_STRUCT_MEMBER( mUpwardsHeight );
  TAC_META_REGISTER_STRUCT_MEMBER( mHeightmapTexturePath );
  TAC_META_REGISTER_STRUCT_MEMBER( mGroundTexturePath );
  TAC_META_REGISTER_STRUCT_MEMBER( mNoiseTexturePath );
