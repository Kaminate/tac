...
namespace Tac
{
  ...
  TAC_META_REGISTER_STRUCT_BEGIN( Material );
  TAC_META_REGISTER_STRUCT_MEMBER( mIsGlTF_PBR_MetallicRoughness );
  TAC_META_REGISTER_STRUCT_MEMBER( mIsGlTF_PBR_SpecularGlossiness );
  TAC_META_REGISTER_STRUCT_MEMBER( mPBR_Factor_Metallic );
  TAC_META_REGISTER_STRUCT_MEMBER( mPBR_Factor_Roughness );
  TAC_META_REGISTER_STRUCT_MEMBER( mPBR_Factor_Diffuse );
  TAC_META_REGISTER_STRUCT_MEMBER( mPBR_Factor_Specular );
  TAC_META_REGISTER_STRUCT_MEMBER( mPBR_Factor_Glossiness );
  TAC_META_REGISTER_STRUCT_MEMBER( mColor );
  TAC_META_REGISTER_STRUCT_MEMBER( mEmissive );
  TAC_META_REGISTER_STRUCT_MEMBER( mTextureDiffuse );
  TAC_META_REGISTER_STRUCT_MEMBER( mTextureSpecular );
  TAC_META_REGISTER_STRUCT_MEMBER( mTextureGlossiness );
  TAC_META_REGISTER_STRUCT_MEMBER( mTextureMetallic );
  TAC_META_REGISTER_STRUCT_MEMBER( mTextureRoughness );
  TAC_META_REGISTER_STRUCT_MEMBER( mShaderGraph );
  TAC_META_REGISTER_STRUCT_MEMBER( mRenderEnabled );
  TAC_META_REGISTER_STRUCT_END( Material );
