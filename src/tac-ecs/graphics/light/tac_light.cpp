...
namespace Tac
{
  ...
  TAC_META_REGISTER_STRUCT_BEGIN( Light );
  TAC_META_REGISTER_STRUCT_MEMBER( mSpotHalfFOVRadians );
  TAC_META_REGISTER_STRUCT_MEMBER( mType );
  TAC_META_REGISTER_STRUCT_MEMBER( mShadowResolution );
  TAC_META_REGISTER_STRUCT_MEMBER( mOverrideClipPlanes );
  TAC_META_REGISTER_STRUCT_MEMBER( mFarPlaneOverride );
