...
namespace Tac
{
  struct OtherPlayer
  {
    ...
    Timestamp      mTimeStamp      {}; // Last acknowledged
    LagTest        delayedNetMsg   {};
    ConnectionUUID mConnectionUUID { NullConnectionUUID };
  };

  using ServerSendNetworkMessageCallback = void( * )( ConnectionUUID,
                                                      const void* bytes,
                                                      int byteCount,
                                                      void* userData );
  ...
  struct ServerData
  {
    ...
    void Update( float seconds, ServerSendNetworkMessageCallback, void* userData, Errors& );
